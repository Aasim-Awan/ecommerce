...
class ForgetOTPScreen extends StatefulWidget {
  ...
  const ForgetOTPScreen({super.key, required this.emailOrPhone});
      ...
      child: Obx(
        () => Stack(
          ...
          children: [
                      ...
                      child: Column(
                        children: [
                          ...
                          CustomFormField(
                            controller: tokenTextController,
                            keyboardType: TextInputType.number,
                            validator: (token) => ValidationRules().normal(token),
                          ),
            ...
            otpController.isLoading.value ? const LoaderCircle() : const SizedBox(),
          ],
        ),
      ),
    );
